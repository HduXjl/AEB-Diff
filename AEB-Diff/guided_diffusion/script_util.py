import argparse
import inspect
from .distribution import  AxisAlignedConvGaussian, AxisAlignedConvBeta
...
def create_model_and_diffusion(
    ...
    prior = AxisAlignedConvBeta(
        input_channels=input_channels_dist,
